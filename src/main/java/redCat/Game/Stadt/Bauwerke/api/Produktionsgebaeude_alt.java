...
import redCat.Game.Stadt.Bauwerke.impl.PGebaeude;

public class Produktionsgebaeude_alt extends Gebaeude implements PGebaeude {
	...
	public Produktionsgebaeude_alt() {
		super();
	 ...
	 */ 
	public Produktionsgebaeude_alt(String name, String zeitalter, int muenzen, int werkzeug, int personen, int diamanten,
