...
public class Chalet extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/chalet1.xml";
	...
	public Chalet(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
