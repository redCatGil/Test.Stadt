...
public class Landhaus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/landhaus1.xml";
	...
	public Landhaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
