...
public class Pfahlbau extends Wohngebaeude  {
	
	private final String DSN = "ressource/main/xml/pfahlbau1.xml";
	...
	public Pfahlbau(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
