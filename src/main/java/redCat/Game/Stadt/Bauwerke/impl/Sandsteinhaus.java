...
public class Sandsteinhaus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/sandsteinhaus1.xml";

	public Sandsteinhaus() {
		super();
	...
	public Sandsteinhaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
