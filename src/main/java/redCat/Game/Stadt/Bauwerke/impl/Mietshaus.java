...
public class Mietshaus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/mietshaus1.xml";
	...
	public Mietshaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
