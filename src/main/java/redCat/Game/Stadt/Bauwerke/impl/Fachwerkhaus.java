...
public class Fachwerkhaus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/fachwerkhaus1.xml";
	...
	public Fachwerkhaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
