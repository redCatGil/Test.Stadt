...
public class Schindelhaus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/schindelhaus1.xml";
	...
	public Schindelhaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
