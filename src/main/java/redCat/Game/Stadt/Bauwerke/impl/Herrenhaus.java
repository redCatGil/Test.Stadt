...
public class Herrenhaus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/herrenhaus1.xml";
	...
	public Herrenhaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
