...
public class Metzgerei extends Produktionsgebaeude {
	
	private final String DSN = "ressource/main/xml/metzgerei1.xml";
	...
	public Metzgerei(String name, String zeitalter, int muenzen, int werkzeug,
