...
public class Villa extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/villa1.xml";
	...
	public Villa(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
