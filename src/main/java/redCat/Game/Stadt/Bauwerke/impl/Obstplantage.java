...
public class Obstplantage extends Produktionsgebaeude {
	
	private final String DSN = "ressource/main/xml/obstplantage1.xml";
	...
	public Obstplantage(String name, String zeitalter, int muenzen, int werkzeug,
