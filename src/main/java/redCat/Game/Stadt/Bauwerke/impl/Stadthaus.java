...
public class Stadthaus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/stadthaus1.xml";
	...
	public Stadthaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
