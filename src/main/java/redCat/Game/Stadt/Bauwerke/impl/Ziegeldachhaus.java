...
public class Ziegeldachhaus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/ziegeldachhaus1.xml";

	public Ziegeldachhaus() {
		super();
	...
	public Ziegeldachhaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
