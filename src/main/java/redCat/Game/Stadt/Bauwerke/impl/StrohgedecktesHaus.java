...
public class StrohgedecktesHaus extends Wohngebaeude {
	private final String DSN = "ressource/main/xml/strohgedecktes_Haus1.xml";

	public StrohgedecktesHaus() {
		super();
	...
	public StrohgedecktesHaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
