...
public class Gutshaus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/gutshaus1.xml";
	...
	public Gutshaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
