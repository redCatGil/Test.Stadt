...
public class Arkadenhaus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/arkadenhaus1.xml";
	...
	public Arkadenhaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
