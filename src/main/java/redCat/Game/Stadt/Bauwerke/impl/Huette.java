...
public class Huette extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/huette1.xml";
	...
	public Huette(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
