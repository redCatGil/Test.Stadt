...
public class Kolonialhaus extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/kolonialhaus1.xml";
	...
	public Kolonialhaus(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
