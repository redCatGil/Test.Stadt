...
public class Schmiede extends Produktionsgebaeude {
	
	private final String DSN = "ressource/main/xml/schmiede1.xml";
	...
	public Schmiede(String name, String zeitalter, int muenzen, int werkzeug,
