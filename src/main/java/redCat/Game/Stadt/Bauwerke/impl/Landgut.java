...
public class Landgut extends Wohngebaeude {
	
	private final String DSN = "ressource/main/xml/landgut1.xml";
	...
	public Landgut(String name, String zeitalter, int muenzen, int werkzeug, int diamanten, int laenge, int breite,
