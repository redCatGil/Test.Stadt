...
//					System.out.println(wog.toString());
					...
					//wenn ein Objekt ausgewählt wurde, wird die Eingabe aktiviert: txtAnzahl und scaleAnzahl werden eingabefähig
			...
			public void modifyText(ModifyEvent arg0) {
				if (cbAus.getSelectionIndex() > -1) {
					try {
						...
						//ist die eingegebene Anzahl größer, wird sie auf SCALEMAX gesetzt
						if (anzahl > SCALEMAX) {
							anzahl = SCALEMAX;
							txtAnzahl.setText(""+anzahl);
						}
						//eingegebne Anzahl auf die Scala übertragen
